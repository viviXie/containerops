...
export function getSequenceDetail(selected_history) {
    ...
    var promise = historyDataService.getPipelineHistory(selected_history.workflowName, selected_history.versionName, selected_history.sequence);
    promise.done(function(data) {
        loading.hide();
...
function timerSequencePipelineData(refreshSelect_hisotry){
    var promise = historyDataService.getPipelineHistory(refreshSelect_hisotry.workflowName, refreshSelect_hisotry.versionName, refreshSelect_hisotry.sequence);
    promise.done(function(data) {
        loading.hide();
        constant.refreshSequenceRunData = data.define.stageList;
