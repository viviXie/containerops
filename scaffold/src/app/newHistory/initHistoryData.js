...
export function historyResouce(workflowName,workflowId,workflowResource){
	return workflowHistoryApi.workflowResouce(workflowName,workflowId,workflowResource);
}


export function sequenceResouce(){
	return workflowHistoryApi.sequenceResouce();
}
